    ...
    <div style={{
      ...
      <div className="card" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--text-primary)', letterSpacing: '-0.01em' }}>Welcome Back</h1>
        ...
        <div style={{ textAlign: 'center', marginTop: 20 }}>
          ...
          <Link to="/register" style={{ fontSize: 13, color: 'var(--primary)', fontWeight: 600, textDecoration: 'none' }}>
            Create Account
          </Link>
        </div>
      </div>
