...
export interface Workflow { id: string; name: string; description?: string; nodes: WorkflowNode[]; connections: Connection[]; active: boolean; version: number; tags: string[]; projectId?: string; }
