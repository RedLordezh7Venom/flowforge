...
export const GoogleSheetsConnector: Connector = {
  ...
  operations: {
    readRows: { name: 'readRows', displayName: 'Read Rows', method: 'GET', path: '/spreadsheets/{spreadsheetId}/values/{range}' },
    appendRow: { name: 'appendRow', displayName: 'Append Row', method: 'POST', path: '/spreadsheets/{spreadsheetId}/values/{range}:append' },
  },
